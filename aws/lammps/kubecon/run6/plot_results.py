...
def plot_outputs(raw, mpi_operator, plotname, ext="pdf", outdir="img"):
    """
    ...
    # Save raw data frame
    df.to_csv(os.path.join(outdir, "results-combined-df.csv"))
...
def main():
    ...
    for filename in args.results_json, args.mpi_operator:
    ...
    plot_outputs(data, mpi_operator, args.plotname, ext=args.extension, outdir=args.outdir)
