...
JOB="lammps"
LOGFILE="/home/vanessa/Desktop/Code/flux/experiments/aws/lammps/test-optimized-build-x86/data/aws/k8s-size-8-hpc6a.48xlarge/lmp-8-20-minicluster-size-8/log.out"
