...
def get_parser():
    ...
    parser.add_argument(
        ...
        default=os.path.join(here, "results", "lammps-mixed"),
    )
    parser.add_argument(
        "--out",
...
def plot_results(df, outdir):
    ...
    make_plot(
        df,
        title="LAMMPS Wall Times for Different Schedulers",
    ...
    make_plot(
        df,
        title="LAMMPS Total Pods Running Time for Different Schedulers",
